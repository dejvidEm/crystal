export const en = {
  ...
  contactForm: {
    title: "Write to us",
    subtitle: "Have a question or a specific request? Send a message and we'll get back to you.",
    nameLabel: "Name",
    ...
    successText: "We'll get back to you shortly — usually within one business day.",
    errorGeneric: "Something went wrong. Please try again.",
    consent: "By submitting you agree to the processing of your contact details to handle the inquiry.",
  },
  footer: {
  ...
  calculator: {
    ...
    step4Title: "Interested in any add-on services? (optional)",
    step4Subtitle:
      "Selected services are priced individually on-site — they are not included in the price above.",
    addonSeats: "Seat shampooing",
    addonSeatsDesc: "Deep extraction of fabric seats.",
    addonCarpets: "Carpet shampooing",
    addonCarpetsDesc: "Shampooing of floor carpets and mats.",
    addonLeather: "Leather seat & trim conditioning",
    ...
    priceBreakdownLargeVehicle: "Large vehicle surcharge",
    priceBreakdownExtremeCondition: "Extreme dirt surcharge",
    priceBreakdownTotal: "Total",
    priceBreakdownAddonsNote: "Add-on services are priced individually on-site.",
    leadTitle: "Want a no-obligation quote?",
    leadSubtitle: "Leave us your details and we'll get back to you with an exact price and time slot.",
    leadPhoneLabel: "Phone",
    leadEmailLabel: "Email",
    leadSubmit: "Send no-obligation inquiry",
    leadSubmitting: "Sending...",
    leadConsent: "By submitting you agree to the processing of your contact details to handle the inquiry.",
    leadSuccessTitle: "Thanks, we've received your inquiry.",
    leadSuccessText: "We'll get in touch shortly with a no-obligation quote using the contacts you provided.",
