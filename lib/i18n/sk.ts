export const sk = {
  ...
  heroLead: {
    badge: "Poskytujeme služby 7 dní v týždni",
    title: "Mobilné čistenie auta priamo u vás v Bratislave.",
    subtitle:
      "Prídeme k vám domov alebo do práce. Bez presunov, čakania v zápche a potreby pripojenia na vodu alebo elektrinu.",
    socialProof: "Viac ako 50+ spokojných zákazníkov",
    socialProofAria: "Hodnotenie 5 z 5 hviezdičiek",
    trust1: "Výjazd po celej Bratislave",
    trust2: "Prídeme k vám domov alebo do práce",
    trust3: "Bez potreby vody a elektriny",
    formTitle: "Bezplatná kalkulácia",
    formSubtitle: "Vyplňte formulár pre nezáväznú cenovú ponuku mobilného detailingu.",
    nameLabel: "Meno",
    ...
    consentBeforeLink: "Odoslaním tohto formulára súhlasím so spracovaním osobných údajov podľa",
    consentLink: "zásad ochrany osobných údajov",
    consentRequired: "Pred odoslaním potvrďte súhlas so spracovaním údajov.",
    submit: "Získať kalkuláciu zadarmo",
    submitting: "Odosielam...",
    submitNote: "Po odoslaní sa s vami spojíme do 24 hodín a radi odpovieme na otázky.",
    successTitle: "Ďakujeme, dopyt odoslaný.",
    successText: "Ozveme sa vám do 24 hodín s cenou a najbližším termínom.",
  ...
  handoverShowcase: {
    ...
    sameResultCta: "Chcem rovnaký výsledok",
  },
  about: {
  ...
  services: {
    ...
    travelNote: {
      ...
      perKmFee: "0,50 €/km",
      petHairLabel: "Zvieracie chlpy",
      petHairFee: "+20 €",
      extraDirtyLabel: "Nadmerné znečistenie",
      extraDirtyFee: "20 % z ceny",
    },
  ...
  carSizes: {
    small: "Malé",
    smallDesc: "Hatchback / Sedan",
    suv: "Stredné",
    suvDesc: "Kombi / Malé SUV",
    van: "Veľké",
    vanDesc: "Veľké SUV / Dodávka",
  },
  additionalServices: {
  ...
  reviews: {
    title: "Viac ako 50 zákazníkov nás hodnotilo 5 hviezdičkami",
    subtitle:
      "Reálne Google recenzie od zákazníkov, ktorým sme čistili auto doma alebo v práci v Bratislave.",
  ...
  bookingFlow: {
    ...
    subtitle: "Vyberte vozidlo, službu a voľný termín. Rezerváciu vám potvrdíme.",
    step: "Krok",
    of: "z",
    back: "Späť",
    next: "Ďalej",
    ...
    submitting: "Odosielam...",
    stepVehicle: "Akú máte veľkosť vozidla?",
    vehicleSmall: "Malé",
    vehicleSmallDesc: "Hatchback / Sedan",
    vehicleMedium: "Stredné",
    vehicleMediumDesc: "Kombi / Malé SUV",
    vehicleLarge: "Veľké",
    vehicleLargeDesc: "Veľké SUV / Dodávka",
    stepService: "Akú službu potrebujete?",
    serviceTepovanie: "Tepovanie",
    serviceTepovanieDesc: "Samostatné profesionálne tepovanie interiéru",
    stepExtras: "Niečo navyše?",
    stepExtrasSubtitle: "Voliteľné doplnky. Tepovanie sa zobrazí, ak ste ho nevybrali ako hlavnú službu.",
    extraTepovanie: "Tepovanie interiéru",
    extraTepovanieDesc: "Hĺbkové tepovanie sedačiek, kobercov a textílií.",
    extraClimate: "Čistenie klimatizácie",
    extraClimateDesc: "Dezinfekcia a osvieženie klimatizačného systému.",
    extraPlastics: "Impregnácia plastov",
    extraPlasticsDesc: "Ošetrenie a ochrana plastových častí interiéru.",
    extraLeather: "Impregnácia kože",
    extraLeatherDesc: "Čistenie a výživa kožených povrchov.",
    extraHeadlights: "Renovácia svetlometov",
    extraHeadlightsDesc: "Obnova zakalených a zažltnutých svetlometov.",
    extraEngine: "Čistenie motorového priestoru",
    extraEngineDesc: "Šetrné vyčistenie motorového priestoru.",
    extrasNone: "Bez doplnkov",
    stepAddress: "Kde máme prísť?",
    addressLabel: "Adresa",
    addressPlaceholder: "Ulica, číslo, mesto",
    addressHint: "Prídeme priamo k vám domov alebo do práce s vlastnou vodou a elektrinou.",
    nameLabel: "Meno a priezvisko",
    phoneLabel: "Telefón",
    emailLabel: "E-mail",
    notesLabel: "Poznámka (voliteľné)",
    notesPlaceholder: "Typ auta, parkovanie, vchod…",
    stepWhen: "Vyberte termín",
    monthPrev: "Predchádzajúci mesiac",
    monthNext: "Ďalší mesiac",
    noSlots: "V tento deň už nie sú voľné časy.",
    pickDay: "Vyberte deň v kalendári.",
    legendAvailable: "Celý deň voľný",
    legendPartial: "Ešte sú voľné časy",
    legendFull: "Obsadené",
    legendClosed: "Zatvorené",
    estimate: "Odhadovaná cena",
    estimateNote: "Konečnú cenu potvrdíme pred začatím práce.",
    successTitle: "Ďakujeme, rezervácia je odoslaná",
    successText:
      "Vašu rezerváciu teraz skontrolujeme. Potvrdzujúci e-mail vám príde až po schválení termínu.",
    successBack: "Späť na úvod",
    errorGeneric: "Rezerváciu sa nepodarilo odoslať. Skúste to znova.",
    consent: "Odoslaním súhlasíte so spracovaním údajov na vybavenie rezervácie.",
  },
}
